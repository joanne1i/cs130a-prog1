...
// run item through all the hash functions use results as indices 
// into the bits array and set those bits as one
...
// run item through all the hash functions use results to index into 
// the bits and report true if all referenced bits are one
